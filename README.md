Reducing Readmissions – Hospital Data Analytics Case Study

Project Overview - 
Hospital readmissions within 30 days are a major concern for healthcare organizations as they increase costs, strain hospital resources, and may indicate gaps in quality of care.
In this project, I worked as a Data Analyst in a hospital administration setting (Novartis case scenario) to analyze hospital admission data and identify patterns and factors associated
with high readmission rates. The ultimate goal was to generate data-driven insights that can help stakeholders reduce unnecessary readmissions and improve patient outcomes.
This entire project was completed using Microsoft Excel, focusing on strong analytical thinking, data cleaning, pivot-based analysis, and business interpretation.
...
Conclusion -
This project demonstrates how Excel-based analytics,when combined with strong domain
understanding, can deliver meaningful insights in healthcare. The analysis provides a foundation for
